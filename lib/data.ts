...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: "HeartPulse",
    items: [
      { name: "Electronic Medical Records", level: 80 },
      { name: "Health Information Systems", level: 82 },
      { name: "Medical Data Standards", level: 75 },
    ],
  },
  {
    title: "Data & AI",
...
export const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    images: [
      ...
      { src: "/images/gallery/AI workshop 1.jpeg", alt: "AI workshop (TAS)" },
      { src: "/images/gallery/gallery-5.svg", alt: "Coding late night session" },
    ],
  },
  {
    id: "g2",
    ...
    category: "Workshops",
    images: [
      { src: "/images/gallery/gallery-4.svg", alt: "Group project presentation" },
      { src: "/images/gallery/gallery-6.svg", alt: "Healthcare tech conference" },
    ],
  },
  {
    id: "g3",
